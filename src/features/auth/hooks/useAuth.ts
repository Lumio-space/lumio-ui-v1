...
export function useLogout() {
  ...
  return useMutation({
    ...
    onSuccess: () => { clearAuthCookie(); setAuthenticated(false); clearUser(); router.push('/login') },
    onError:   () => { clearAuthCookie(); setAuthenticated(false); clearUser(); router.push('/login') },
  })
}
